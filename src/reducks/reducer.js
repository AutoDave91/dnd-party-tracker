...
const initialState ={
    ...
    data: [
        ...
        ,
        {campaign: 'Winds of Change', player: 'AutoDave', name: 'Gnaagark', class: 'Barbarian', role: 'Tank', lvl: 3, max_hp: 25, ac: 15, current_hp: 25, temp_hp: 0, str: 17, dex: 14, con: 16, int: 10, wis: 8, cha: 8, health: 'ok'},
        {campaign: 'Winds of Change', player: 'CodyNo', name: 'Throfir', class: 'Fighter', role: 'Tank', lvl: 2, max_hp: 20, ac: 18, current_hp: 20, temp_hp: 0, str: 17, dex: 12, con: 14, int: 10, wis: 12, cha: 12, health: 'ok'},
        {campaign: 'Winds of Change', player: 'SwordsaintIIV', name: 'Serr', class: 'Fighter', role: 'Tank', lvl: 3, max_hp: 23, ac: 19, current_hp: 23, temp_hp: 0, str: 15, dex: 16, con: 13, int: 11, wis: 14, cha: 9, health: 'ok'},
        ...
        {campaign: 'Winds of Change', player: 'ml1201', name: 'Zealvari', class: 'Cleric', role: 'Healer', lvl: 2, max_hp: 18, ac: 18, current_hp: 18, temp_hp: 0, str: 14, dex: 8, con: 14, int: 13, wis: 17, cha: 17, health: 'ok'}
        // {campaign: 'Winds of Change', player: 'Will', name: 'Dog', class: 'Companion', role: 'Damage', lvl: 0, max_hp: 0, ac: 0, current_hp: 0, temp_hp: 0, str: 0, dex: 0, con: 0, int: 0, wis: 0, cha: 0, health: 'ok'}
    ]
}
